...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" autocomplete="off"  id="form-actual-bill" enctype="multipart/form-data" action="{{ route('karyawan.approval.training-atasan.proses-biaya') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <?php 
                            $readonly = "";
                            if($data->is_approve_atasan_actual_bill == 1)
                            {
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="transportasi_gasoline_catatan" value="{{ $data->transportasi_gasoline_catatan }}" class="form-control" {{$readonly}} /></td>
                                </tr>
                                <tr>
                                    <td>Tol</td>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                             <tr>
                                ...
                                <?php  $item = plafond_perjalanan_dinas($data->user->organisasiposition->name); ?>
                                <tr>
                                    <td>Hotel</td>
                                    <td>
                        ...
                        <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="uang_biaya_lainnya1_nominal" value="{{ $data->uang_biaya_lainnya1_nominal }}" class="form-control" placeholder="Rp. " readonly="true" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control" value="{{ $data->uang_biaya_lainnya2_nominal }}" name="uang_biaya_lainnya2_nominal" placeholder="Rp. " readonly="true" />
                                    </td>
                                    <td>
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right;">Total Actual Bill Disetujui </th>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right;">
                                        <?php
                                            if($data->sub_total_1_disetujui + $data->sub_total_2_disetujui + $data->sub_total_3_disetujui - $data->pengambilan_uang_muka < 0){
                                                echo "Total Pengembalian";
                                            }else{
                                                echo "Total Reimbursement Disetujui";
                                            }
                                        ?>
                                    </th>
                                ...
                                <tr>
                                    <th>Note</th>
                                    <td colspan="5"><input type="text" class="form-control" readonly="true" placeholder="Note here.." name="noted_bill" value="{{ $data->noted_bill }}"></td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="col-md-12" style="padding-left: 0;">
                            ...
                            @if($data->is_approve_atasan_actual_bill == "")
