                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control autcomplete-atasan" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="tanggal_cuti_start" class="form-control" id="from" placeholder="Start Tanggal" required />
                                </div>
                                <div class="col-md-5">
                                    <input type="text" name="tanggal_cuti_end" class="form-control" id="to" placeholder="End Tanggal" required>
                                </div>
                                <div class="col-md-2">
...
<script type="text/javascript">
    ...
    $("#btn_submit_form").click(function(){
        ...
        // Validasi data
        if($("input[name='jenis_cuti']").val() == "" || $("#jenis_cuti").val() == "" || $("input[name='backup_user_id']").val() == "" || $("textarea[name='keperluan']").val() == "" ||  $("input[name='tanggal_cuti_start']").val() == "" || $("input[name='tanggal_cuti_end']").val() == "" )
        {
